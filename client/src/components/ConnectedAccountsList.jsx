...
import './ConnectedAccountsList.css';

const ConnectedAccountsList = ({ accounts, isLoading, onDelete, onReconnect }) => {
    if (isLoading) {
            ...
            {accounts.map((account) => (
                <div key={account.id} className="account-item">
                    ...
                    <button
                        ...
                        onClick={() => onDelete(account.platform, account.accountId)}
